...
pieces:
	...
	; 2. J PIECE
	; =========================================================================
	; Rotation 0 (Pointing Left)
	.byte $FF, $00,  $00, $00,  $01, $FF,  $01, $00
	; Rotation 1 (Pointing Up)
	.byte $FF, $FF,  $00, $FF,  $00, $00,  $00, $01
	; Rotation 2 (Pointing Right)
	.byte $FF, $00,  $FF, $01,  $00, $00,  $01, $00
	...
	; Rotation 1 (Duplicate)
	.byte $FF, $FF,  $FF, $00,  $00, $FF,  $00, $00
	; Rotation 2 (Duplicate)
	.byte $FF, $FF,  $FF, $00,  $00, $FF,  $00, $00
	; Rotation 3 (Duplicate)
	.byte $FF, $FF,  $FF, $00,  $00, $FF,  $00, $00

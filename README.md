# nes-tetris-coop
A co-op NES Tetris clone, built from the ground up. I tried my best as a solo amateur NES programmer (there's no soft drop score yet, will add later, but soft drop exists)
